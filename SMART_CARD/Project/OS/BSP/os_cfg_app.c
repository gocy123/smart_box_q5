...
//note: when add any task , assert below info to os_cfg_app.h file.
OS_TCB  	DeviceManageTask_Tcb;
#pragma data_alignment=8
CPU_STK 	DeviceManageTask_Stk[DEVICE_MANAGE_TASK_STK_SIZE];

OS_TCB  	Can0ManageTask_Tcb;
//#pragma data_alignment=8
CPU_STK 	Can0ManageTask_Stk[CAN0_MANAGE_TASK_STK_SIZE];

OS_TCB  	GpsTask_Tcb;
//#pragma data_alignment=8
CPU_STK 	GpsTask_Stk[GPS_TASK_STK_SIZE];

OS_TCB  	ISO15765Task_Tcb;
//#pragma data_alignment=8
CPU_STK 	ISO15765Task_Stk[ISO15765_TASK_STK_SIZE];

OS_TCB  	ModemManageTask_Tcb;
//#pragma data_alignment=8
CPU_STK 	ModemManageTask_Stk[MODEM_MANAGE_TASK_STK_SIZE];

OS_TCB  	modem_receive_task_Tcb;
//#pragma data_alignment=8
CPU_STK 	modem_receive_task_Stk[MODEM_RECEIV_TASK_STK_SIZE];

OS_TCB  	telecom_prot_manage_task_Tcb;
//#pragma data_alignment=8
CPU_STK 	telecom_prot_manage_task_stk[TELECOM_PROT_MANAGE_TASK_STK_SIZE];

OS_TCB  	period_report_save_task_Tcb;
//#pragma data_alignment=8
CPU_STK 	period_rep_save_task_stk[PERIOD_REP_SAVE_TASK_STK_SIZE];

OS_TCB  	remote_report_task_Tcb;
//#pragma data_alignment=8
CPU_STK 	remote_report_task_stk[REMOTE_REPORT_TASK_STK_SIZE];

OS_TCB  	remote_receive_task_Tcb;
//#pragma data_alignment=8
CPU_STK 	remote_receive_task_stk[REMOTE_RECEIVE_TASK_STK_SIZE];

OS_TCB  	storage_task_Tcb;
//#pragma data_alignment=8
CPU_STK 	storage_task_stk[STORAGE_TASK_STK_SIZE];

OS_TCB  	rf_task_Tcb;
//#pragma data_alignment=8
CPU_STK 	rf_task_stk[RF_TASK_STK_SIZE];

// msg
OS_Q ISO15765_RX_CAN_MSG_Q;
OS_Q ISO15765_RX_APP_DATA_Q;
...
#define _____USER_DEFINE__________________________________
