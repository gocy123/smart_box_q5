...
#define OS_CFG_TS_EN                    1u   /* Enable (1) or Disable (0) timestamps                                  */

#define OS_CFG_PEND_MULTI_EN            1u   /* Enable (1) or Disable (0) code generation for multi-pend feature      */

#define OS_CFG_PRIO_MAX                 20u  //zgc 8u /* Defines the maximum number of task priorities (see OS_PRIO data type) */
...
#define OS_CFG_SEM_SET_EN               1u   /*    Include code for OSSemSet()                                        */
                                             ...
                                             /* -------------------------- TASK MANAGEMENT -------------------------- */
#define OS_CFG_STAT_TASK_EN             0u // zgc 1u   /* Enable (1) or Disable(0) the statistics task                          */
