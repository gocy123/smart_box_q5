...
extern enum rt_ringbuffer_state rt_ringbuffer_status(struct rt_ringbuffer *rb);
extern uint16_t rt_ringbuffer_data_len(struct rt_ringbuffer *rb);
#else
...
static inline uint16_t rt_ringbuffer_data_len(struct rt_ringbuffer *rb)
{
